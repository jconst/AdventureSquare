...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 6189119;
    var PACKAGE_UUID = '53379a3f-34aa-4669-be5e-a35d744d95b4';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(180248, 209528, 0, 0).open('GET', '/mainData');
    new DataRequest(209528, 209547, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(209547, 217019, 0, 0).open('GET', '/resources.assets');
    new DataRequest(217019, 3951259, 0, 0).open('GET', '/resources.resource');
    new DataRequest(3951259, 4050511, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(4050511, 4054703, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(4054703, 4058979, 0, 0).open('GET', '/sharedassets10.assets');
    new DataRequest(4058979, 4063231, 0, 0).open('GET', '/sharedassets11.assets');
    new DataRequest(4063231, 4083711, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(4083711, 4087975, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(4087975, 4092359, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(4092359, 4096587, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(4096587, 4100863, 0, 0).open('GET', '/sharedassets6.assets');
    new DataRequest(4100863, 4105091, 0, 0).open('GET', '/sharedassets7.assets');
    new DataRequest(4105091, 4109343, 0, 0).open('GET', '/sharedassets8.assets');
    new DataRequest(4109343, 4113607, 0, 0).open('GET', '/sharedassets9.assets');
    new DataRequest(4113607, 5688643, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5688643, 6189119, 0, 0).open('GET', '/Resources/unity_builtin_extra');
